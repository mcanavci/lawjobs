    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex flex-col gap-4 md:flex-row">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="block w-full rounded-lg border-0 py-2 pl-10 pr-4 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-navy-600 sm:text-sm sm:leading-6"
                  value={searchTerm}
              ...
              <button
                type="button"
                className="inline-flex items-center gap-x-2 rounded-lg bg-navy-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-navy-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-navy-600"
              >
      ...
      <div id="jobs-section" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="lg:hidden mb-4">
          <button
            type="button"
            className="w-full flex items-center justify-center gap-x-2.5 rounded-lg bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          >
            ...
            {/* Filters Panel */}
            <div className={`
              ${showMobileFilters ? 'fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 lg:relative lg:block lg:w-full lg:px-0 lg:py-0' : ''}
              lg:block
            `}>
